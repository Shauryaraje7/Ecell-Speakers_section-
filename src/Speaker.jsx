...
import slide_image_1 from './assets/images/Ankita Saxena.png';
import slide_image_2 from './assets/images/Devesh B.png';
import slide_image_3 from './assets/images/IDK the name of this guy.png';
import slide_image_4 from './assets/images/Kafi Khan.png';
...
const members = [
  { name: "Ankita Saxena", position: "Lead", linkedIn: "https://linkedin.com/in/lead", img: slide_image_1 },
  { name: "Devesh B", position: "Co-Lead", linkedIn: "https://linkedin.com/in/colead1", img: slide_image_2 },
  { name: "IDK the name of this guy", position: "Member", linkedIn: "https://linkedin.com/in/member1", img: slide_image_3 },
  { name: "Kafi Khan", position: "Member", linkedIn: "https://linkedin.com/in/member2", img: slide_image_4 },
...
function Coordinators() {
  return (
    <div className="container">
      <h1 className="heading">Co-ordinator</h1>
      <Swiper
        effect="coverflow"
        grabCursor={true}
        centeredSlides={true}
